...
var stoppedDuration = 0; //how long was the timeer stopped
...
function clockRunning() {
    ...
    var timeElasped = new Date(currentTime - timeBegan - stoppedDuration);

    var minutes = timeElasped.getUTCMinutes();
    var seconds = timeElasped.getUTCSeconds();
    var milliseconds = timeElasped.getUTCMilliseconds();
